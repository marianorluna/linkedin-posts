      ...
      <ol className="mt-16 flex flex-1 flex-col justify-center gap-10">
        {data.steps.map((step, index) => (
          <li key={`${step.title}-${index}`} className="flex items-start gap-7">
            <span
              className="flex h-[64px] w-[64px] shrink-0 items-center justify-center rounded-full font-[family-name:var(--font-mono)] text-[26px]"
              style={{
            ...
            <div>
              <p
                className="font-[family-name:var(--font-display)] text-[40px] tracking-tight"
              ...
              {step.detail ? (
                <p
                  className="mt-2 font-[family-name:var(--font-body)] text-[24px]"
